...
import '../water_temp_edit_page/water_temp_edit_provider.dart';
...
class _AirTempEditPageState extends ConsumerState<AirTempEditPage> {
  ...
  void initState() {
    ...
    _frequencyController.text = widget.data!.frequency.toString();
  }
