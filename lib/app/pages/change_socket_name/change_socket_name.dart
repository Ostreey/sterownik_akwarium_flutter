  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      onPopInvoked: (_) async {
        ...
        final result =
            await prefs.setStringList('socket_names', widget.socketNames!);
        if (result) {
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text("Zmień nazwę gniazda"),
        ),
        body: SafeArea(
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  ChangeSocketNameWidget(
                      labelName: '1',
                      initSocketName: widget.socketNames![0],
                      onTextChanged: (value) => updateSocketName(0, value)),
                  const SizedBox(height: 44),
                  ChangeSocketNameWidget(
                      labelName: '2',
                      initSocketName: widget.socketNames![1],
                      onTextChanged: (value) => updateSocketName(1, value)),
                  const SizedBox(height: 44),
                  ChangeSocketNameWidget(
                      labelName: '3',
                      initSocketName: widget.socketNames![2],
                      onTextChanged: (value) => updateSocketName(2, value)),
                  const SizedBox(height: 44),
                  ChangeSocketNameWidget(
                      labelName: '4',
                      initSocketName: widget.socketNames![3],
                      onTextChanged: (value) => updateSocketName(3, value)),
                  const SizedBox(height: 44),
                  ChangeSocketNameWidget(
                      labelName: '5',
                      initSocketName: widget.socketNames![4],
                      onTextChanged: (value) => updateSocketName(4, value)),
                  const SizedBox(height: 44),
                  ChangeSocketNameWidget(
                      labelName: '6',
                      initSocketName: widget.socketNames![5],
                      onTextChanged: (value) => updateSocketName(5, value)),
                  const SizedBox(height: 44),
                ],
              ),
            ],
...
class ChangeSocketNameWidget extends StatefulWidget {
  const ChangeSocketNameWidget(
      {super.key,
      required this.labelName,
      required this.initSocketName,
...
class _ChangeSocketNameWidgetState extends State<ChangeSocketNameWidget> {
  ...
  void handleSuffixIcon() {
    socketNameController.text.isNotEmpty
        ? isSuffixIconVisible
        : !isSuffixIconVisible;
    setState(() {
      isSuffixIconVisible;
